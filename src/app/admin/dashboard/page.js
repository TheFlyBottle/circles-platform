    ...
    <div className="animate-fade-in" style={{ padding: '2rem 0' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
        ...
        <Link href="/admin/circle-proposals" className="card hover-card" style={{ textDecoration: 'none', color: 'inherit', display: 'flex', flexDirection: 'column', padding: '2rem' }}>
          ...
          <h3 className="font-serif" style={{ fontSize: '1.5rem', margin: '0 0 0.5rem 0', color: 'var(--accent-primary)' }}>Circle Proposals</h3>
          <p style={{ margin: 0, color: 'var(--text-secondary)', lineHeight: 1.5 }}>Review and manage user-submitted proposals for new circles.</p>
        </Link>
      </div>
